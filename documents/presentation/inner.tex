...
\begin{frame}{Outline}
    ...
    \pnote{
        ...
        I'll show an interesting example of something novel implemented by me.\\
...
% 		\item Proof construction: applying (deduction) steps
...
\begin{frame}{Premise Selection in ITP}
    ...
    \pnote{
        ...
        it sees that you want to prove some property on natural numbers,\\
        and thus it suggests that you use induction on natural numbers, for example.
    }
\end{frame}
...
\begin{frame}{Source research}
    ...
    \pnote{
        ...
        Basically I read their research, implemented their methods, reproduced their results,\\
