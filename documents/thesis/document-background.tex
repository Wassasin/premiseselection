...
\begin{definition}[{\coqobj[s]}]\defgls{coqobj}
	...
	\begin{tabular}{l|l|l|l}
		given $s = \text{Constant}(n,~ t,~ A)$ & $\name[s] = n$ & $\term[s] = t$ & $\type[s] = A$ \\
		given $s = \text{Variable}(n,~ t,~ A)$ & $\name[s] = n$ & $\term[s] = t$ & $\type[s] = A$ \\
		given $s = \text{CurrentProof}(n,~ \text{hyps},~ t,~ A)$ & $\name[s] = n$ & $\term[s] = t$ & $\type[s] = A$ \\
		given $s = \text{InductiveConstructor}(n,~ A)$ & $\name[s] = n$ & $\term[s] = \emptyterm$ & $\type[s] = A$ \\
		given $s = \text{InductiveDefinition}(n,~ A,~ cs)$ & $\name[s] = n$ & $\term[s] = \emptyterm$ & $\type[s] = A$
	\end{tabular}
\end{definition}
