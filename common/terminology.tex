...
description={human readable name of the \coqobj[s] as written in the Coq source file}}

\newcommand{\cname}[1][]{c_{#1}}
\newglossaryentry{cname}{name={\ensuremath{\cname[s]}},
description={canonical identifier (URI) of the \coqobj[s]}}

\newcommand{\hcname}[1][]{hc_{#1}}
\newglossaryentry{hcname}{name={\ensuremath{\hcname[s]}},
description={human readable canonical identifier (URI) of the \coqobj[s]}}
