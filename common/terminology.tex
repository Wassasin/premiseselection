...
\newcommand{\supremum}{\top}
\newglossaryentry{supremum}{name={\ensuremath{\supremum}},
description={least element of a poset that is greater than or equal to all elements of that poset}}

\newcommand{\upset}[2]{~{#1}\uparrow{#2}~}
\newglossaryentry{upset}{name={\ensuremath{\upset{X}{x}}},
description={subset of a poset $X$ where each element is larger or equal than a given element $x$}}
