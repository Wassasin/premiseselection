...
\newcommand{\formalin}{CH$_2$O\xspace}
...
% Metrics
\newcommand{\oocover}{Recall@100\xspace}
\newcommand{\oocoverf}[2]{\ensuremath{\text{Recall@100}({#1}, {#2})}}
\newcommand{\ooprecision}{Precision@100\xspace}
\newcommand{\ooprecisionf}[2]{\ensuremath{\text{Precision@100}({#1}, {#2})}}
\newcommand{\recall}{Maximum Rank\xspace}
\newcommand{\recallf}[2]{\ensuremath{\text{maxrank}({#1}, {#2})}}
\newcommand{\rank}{Average Rank\xspace}
\newcommand{\rankf}[2]{\ensuremath{\text{avgrank}({#1}, {#2})}}
\newcommand{\auc}{AUC\xspace}
\newcommand{\aucf}[2]{\ensuremath{\text{AUC}({#1}, {#2})}}
\newcommand{\volume}{Volume\xspace}
\newcommand{\volumef}[2]{\ensuremath{\text{Volume}({#1}, {#2})}}
